...
public class frmBarang extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel3.setText("Cari Nama Barang");
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addComponent(tMerk, javax.swing.GroupLayout.PREFERRED_SIZE, 233, javax.swing.GroupLayout.PREFERRED_SIZE)))
                    .addGroup(layout.createSequentialGroup()
                        .addContainerGap()
        ...
        int jawab = JOptionPane.showConfirmDialog(null, "Apakah yakin menyimpan data?","Konfirmasi",JOptionPane.YES_NO_OPTION);
            ...
            try {
                ...
                if (bTambah.isEnabled()) {
                    //cek kode
                    String cekkode = "SELECT * FROM barang WHERE kode='"+tKode.getText()+"'";
                    rs = st.executeQuery(cekkode);
                    if (rs.next()) {
                        JOptionPane.showMessageDialog(null, "Maaf kode sudah ada");                    
                    } else {
                        //insert                     
                        String sql = "INSERT INTO barang (kode,nama,merk) VALUES ('"+tKode.getText()+
                                 "','"+tNama.getText()+
                                 "','"+tMerk.getText()+"')";
                     ...
                     //update                     
                    String sql = "UPDATE barang SET nama = '"+tNama.getText()+
                            "', merk = '"+tMerk.getText()+
    ...
    private void tblBarangMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tblBarangMouseClicked
        // TODO add your handling code here:
        tKode.setText(tblBarang.getValueAt(tblBarang.getSelectedRow(),1).toString());
        if (!tKode.getText().equals("")) {
            tNama.setText(tblBarang.getValueAt(tblBarang.getSelectedRow(),2).toString());
            tMerk.setText(tblBarang.getValueAt(tblBarang.getSelectedRow(),3).toString());
    ...
    private void bHapusActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bHapusActionPerformed
        ...
        if (tKode.getText().equals("")) {
            ...
            int jawab = JOptionPane.showConfirmDialog(null, "Apakah yakin data barang kode "+tKode.getText()+" akan dihapus?","Konfirmasi",JOptionPane.YES_NO_OPTION);
            if (jawab==0) {
                try {
                    st = kon.createStatement();
                    String hapus = "DELETE FROM barang WHERE kode='"+tKode.getText()+"'";
                    st.execute(hapus);
                    JOptionPane.showMessageDialog(null, "Data barang kode "+tKode.getText()+" berhasil dihapus");
                    Bersih();
                    TampilData();                                                
                } catch (Exception e) {
    ...
    private void bCetakActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bCetakActionPerformed
        ...
        try{
            tblBarang.print(JTable.PrintMode.FIT_WIDTH, header, footer);
