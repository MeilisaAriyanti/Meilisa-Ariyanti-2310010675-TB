...
/**
 *
 * @author Meilisa Ariyanti 2310010675
 */
import java.sql.*;
   ...
   private void TampilData(){
    ...
    private void CariData(){
        try {
            ...
            String sql = "SELECT * FROM barangmasuk WHERE tanggal = '"+tanggal+"%'";
            rs = st.executeQuery(sql);
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    ...
                                    .addGroup(layout.createSequentialGroup()
                                        ...
                                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                            .addGroup(layout.createSequentialGroup()
                                                ...
                                                .addGap(238, 238, 238)
                                                .addComponent(tJumlahAwal, javax.swing.GroupLayout.PREFERRED_SIZE, 122, javax.swing.GroupLayout.PREFERRED_SIZE))
                                            .addGroup(layout.createSequentialGroup()
                                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(layout.createSequentialGroup()
                                ...
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                    .addComponent(tNoKwitansi)
                                    .addComponent(dTanggal, javax.swing.GroupLayout.DEFAULT_SIZE, 190, Short.MAX_VALUE))
                                .addGap(18, 18, 18)
         ...
         if (tNoKwitansi.getText().equals("")) {
            ...
            if (jawab==0) {
                try {
                    ...
                    st = kon.createStatement();
                    String hapus = "DELETE FROM barangmasuk WHERE no_kwitansi='"+tNoKwitansi.getText()+"'";
                    st.execute(hapus);
        ...
        if (jawab==0) {
            try {
                ...
                if (bTambah.isEnabled()) {
                    //cek kode
                    String cekkwitansi = "SELECT * FROM barangmasuk WHERE no_kwitansi='"+tNoKwitansi.getText()+"'";
                    ...
                    if (rs.next()) {
                        ...
                        String sql = "INSERT INTO barangmasuk (tanggal,no_kwitansi,kode,jumlah) VALUES ('"+tanggal+
                                 "','"+tNoKwitansi.getText()+
                                "','"+tKode.getText()+                           
                                 "','"+tJumlah.getText()+"')";
                     ...
                     SimpleDateFormat fm = new SimpleDateFormat(tampilan);
                     String tanggal = String.valueOf(fm.format(dTanggal.getDate()));
                     String sql = "UPDATE barangmasuk SET tanggal = '"+tanggal+                        
    ...
    private void tblMasukMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tblMasukMouseClicked
        // TODO add your handling code here:
        try {
                DefaultTableModel model = (DefaultTableModel)tblMasuk.getModel();
                int index = tblMasuk.getSelectedRow();
                Date date = new SimpleDateFormat("yyyy-mm-dd").parse((String)model.getValueAt(index,1));
                dTanggal.setDate(date);
            } catch (Exception e) {
            }
         tNoKwitansi.setText(tblMasuk.getValueAt(tblMasuk.getSelectedRow(),2).toString());
        if (!tNoKwitansi.getText().equals("")) {
            
            tKode.setText(tblMasuk.getValueAt(tblMasuk.getSelectedRow(),3).toString());
            tJumlah.setText(tblMasuk.getValueAt(tblMasuk.getSelectedRow(),4).toString());
            tJumlahAwal.setText(tblMasuk.getValueAt(tblMasuk.getSelectedRow(),4).toString());
            CariDataBarang();
    ...
    private void bCetakActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bCetakActionPerformed
        ...
        try{
            tblMasuk.print(JTable.PrintMode.FIT_WIDTH, header, footer);
